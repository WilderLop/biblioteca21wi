            ...
            <div class="bg-white rounded-lg formulario">
                ...
                <div class="form-row">
                  ...
                  <div class="col-sm-12 col-md-4 col-lg-3 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom02" required name="barrio" placeholder="Zona" value="<?php echo $fila['Barrio'] ?>" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="16">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                 ...
                 <div class="form-row">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-3 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom05" required name="estado" placeholder="Departamento" value="<?php echo $fila['Estado'] ?>" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="18">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
