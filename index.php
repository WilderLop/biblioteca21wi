...
<body>
	<div class="row m-0 p-0">
			<div class="d-none d-sm-none d-md-block d-lg-block  col-md-7 col-lg-8 p-0">
				<img src="images/pando2.jpg" class="w-100 vh-100" alt="">
				<div class="carousel-caption d-none d-md-block">
			        <h2>Unidad Educativa</h2>
			        <h1 class="text-white">21 de Septiembre</h1>
			     </div>
			</div>
			<div class="bg-white col-sm-12 col-md-5 col-lg-4 p-0">
				<form class="login100-form validate-form p-5" method="POST" action="index.php">
					...
					<div class="d-flex justify-content-center">
						<img class="p-2 rounded-circle" height="75px" width="75px" src="images/pandologo.jpg" style="background: #4E0592;">
					</div>
					<br>
