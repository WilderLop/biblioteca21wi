    ...
    <div class="wrapper">
            ...
            <div class="bg-white rounded-lg formulario">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-4 col-lg-6 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom02"required name="isbn" placeholder="ISBN" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="50">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <!--<div class="invalid-feedback">
                  ...
                  <div class="col-md-4 col-lg-3 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom03" required name="copias" placeholder="Número de copias" pattern="[0-9]{1}">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-4 col-lg-3 mb-4">
                    ...
                    <input type="text" class="form-control" id="validationCustom04" required name="editorial" placeholder="Editorial" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="30">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-4 col-lg-6 mb-4">
                    ...
                    <input type="text" class="form-control" autocomplete="off" id="validationCustom05"required name="pais" placeholder="Pais" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="50">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                 ...
                 <div class="form-row">
                  <div class="col-md-6 col-lg-4 mb-3">
                    ...
                    <input type="date" class="form-control" id="validationCustom06" name="fecha">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom07" required name="cate" placeholder="Categoría" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+" maxlength="30">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
                  ...
                  <div class="col-md-6 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationCustom08" required name="estante" placeholder="Número de estante" pattern="[0-9]{1}">
                    <div class="valid-feedback">
                      Correcto!
                    </div>
                    <div class="invalid-feedback">
     ...
     <?php 
            if (isset($_POST['registrar'])) {
                ...
                $query = "INSERT INTO libros (Titulo,isbn,Copias,Editorial,pais,Fecha_edicion,Categoria,Estante) values('$titulo','$isbn',$copias,'$editorial','$pais','$fecha','$cate',$estante)";
